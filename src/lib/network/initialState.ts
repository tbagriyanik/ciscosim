...
export const commandAliases: Record<string, string> = {
  ...
  'do sh st': 'do show startup-config',
  'do sh sta': 'do show startup-config',
  'do sh star': 'do show startup-config',
  'do sh start': 'do show startup-config',
  'do sh startup': 'do show startup-config',
