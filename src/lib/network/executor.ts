...
export const commandHelp: Record<string, Record<string, string[]>> = {
  ...
  privileged: {
    '': ['configure', 'disable', 'show', 'write', 'ping', 'telnet', 'ssh', 'tracert', 'traceroute', 'reload', 'exit', 'copy', 'erase', 'delete', 'ip', '?', 'help'],
    ...
    'dele': ['delete'],
    'delet': ['delete'],
    'delete': ['flash:vlan.dat', 'nvram', 'flash:config.text'],
    'delete f': ['flash:vlan.dat', 'flash:config.text'],
    'delete fl': ['flash:vlan.dat', 'flash:config.text'],
    'delete fla': ['flash:vlan.dat', 'flash:config.text'],
    'delete flas': ['flash:vlan.dat', 'flash:config.text'],
    'delete flash': ['flash:vlan.dat', 'flash:config.text'],
    'delete flash:': ['vlan.dat', 'config.text'],
    'delete flash:v': ['vlan.dat'],
    'delete flash:vl': ['vlan.dat'],
    'delete flash:vla': ['vlan.dat'],
    'delete flash:vlan': ['vlan.dat'],
    'delete flash:vlan.': ['vlan.dat'],
    'delete flash:vlan.d': ['vlan.dat'],
    'delete flash:vlan.da': ['vlan.dat'],
    ...
    'show interface t': ['trunk'],
    'show interface tr': ['trunk'],
    'show interface tru': ['trunk'],
    'show interface trun': ['trunk'],
    'show interfaces': ['status', 'trunk'],
    'show interfaces t': ['trunk'],
    'show interfaces tr': ['trunk'],
    'show interfaces tru': ['trunk'],
    'show interfaces trun': ['trunk'],
    'show v': ['vlan', 'version'],
    'show vl': ['vlan'],
    'show vla': ['vlan'],
    'show vlan': ['brief'],
    ...
    'copy flash: s': ['startup-config'],
    'copy flash: st': ['startup-config'],
    'copy flash: sta': ['startup-config'],
    'copy flash: star': ['startup-config'],
    'copy flash: start': ['startup-config'],
    'copy flash: startu': ['startup-config'],
    'copy flash: startup': ['startup-config'],
    'copy flash: startup-': ['startup-config'],
    'copy flash: startup-c': ['startup-config'],
    'copy flash: startup-co': ['startup-config'],
    'copy flash: startup-con': ['startup-config'],
    'copy flash: startup-conf': ['startup-config'],
    'copy flash: startup-confi': ['startup-config'],
    ...
    'copy running-config f': ['flash:'],
    'copy running-config fl': ['flash:'],
    'copy running-config fla': ['flash:'],
    'copy running-config flas': ['flash:'],
    'copy running-config flash': ['flash:'],
  ...
  config: {
    ...
    'no enable s': ['secret'],
    'no enable se': ['secret'],
    'no enable sec': ['secret'],
    'no enable secr': ['secret'],
    'no enable secre': ['secret'],
    'no enable secret': [''],
    'no enable p': ['password'],
    'no enable pa': ['password'],
    'no enable pas': ['password'],
    'no enable pass': ['password'],
    'no enable passw': ['password'],
    'no enable passwo': ['password'],
    'no enable passwor': ['password'],
    'no enable password': [''],
    ...
    'n': ['no'],
    'no': ['shutdown', 'vlan', 'cdp', 'service', 'spanning-tree', 'ip'],
  ...
  interface: {
    ...
    'no ip http': ['server'],
    'no ip http s': ['server'],
    'no ip http se': ['server'],
    'no ip http ser': ['server'],
    'no ip http serv': ['server'],
    'no ip http serve': ['server'],
    'no ip http server': [''],
    'no ip a': ['address'],
    'no ip ad': ['address'],
    'no ip add': ['address'],
    ...
    'switchport mo': ['mode'],
    'switchport mod': ['mode'],
    'switchport mode': ['access', 'trunk', 'dynamic', 'dot1q-tunnel'],
    'switchport mode d': ['dynamic', 'dot1q-tunnel'],
    'switchport mode dy': ['dynamic'],
    'switchport mode dyn': ['dynamic'],
    'switchport mode dynam': ['dynamic'],
    'switchport mode dynami': ['dynamic'],
