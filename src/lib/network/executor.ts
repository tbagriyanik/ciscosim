...
export const commandHelp: Record<string, Record<string, string[]>> = {
  ...
  privileged: {
    ...
    ...multi('d', ['disable', 'delete']),
    ...pfx('disable', ['disable']),
    ...pfx('delete', ['flash:vlan.dat', 'nvram', 'flash:config.text']),
    ...npfx('delete', 'flash:vlan.dat', ['vlan.dat']),
    ...pfx('show', ['running-config', 'interfaces', 'vlan', 'version', 'mac', 'cdp', 'ip', 'spanning-tree', 'port-security', 'wireless', 'ssh']),
    ...npfx('show', 'running-config', ['running-config']),
    ...multi('show i', ['interfaces', 'ip']),
    ...npfx('show', 'interfaces', ['status', 'trunk']),
    ...npfx('show interface', 'trunk', ['trunk']),
    ...multi('show v', ['vlan', 'version']),
    ...npfx('show', 'vlan', ['brief']),
    ...npfx('show', 'mac', ['address-table']),
    ...multi('show c', ['cdp', 'clock']),
    ...npfx('show', 'cdp', ['neighbors']),
    ...multi('show ip', ['interface', 'route']),
    ...npfx('show ip', 'interface', ['brief']),
    ...npfx('show ip', 'route', ['route']),
  ...
  config: {
    '': ['hostname', 'interface', 'vlan', 'enable', 'service', 'username', 'line', 'banner', 'ip', 'iot', 'no', 'spanning-tree', 'vtp', 'cdp', 'exit', 'end', 'do', '?', 'help'],
