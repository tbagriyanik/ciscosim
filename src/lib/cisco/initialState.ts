...
export const commandAliases: Record<string, string> = {
  ...
  'writ': 'write memory',
  'write': 'write memory',
  'write m': 'write memory',
  'write me': 'write memory',
  'write mem': 'write memory',
  'write memo': 'write memory',
  'write memor': 'write memory',
  
  'cop': 'copy',
  'copy': 'copy',
  'cop r s': 'copy running-config startup-config',
  'copy r s': 'copy running-config startup-config',
  'cop ru s': 'copy running-config startup-config',
  'copy ru s': 'copy running-config startup-config',
  'cop run s': 'copy running-config startup-config',
  'copy run s': 'copy running-config startup-config',
  'cop run st': 'copy running-config startup-config',
  ...
  'cop run star': 'copy running-config startup-config',
  'copy run star': 'copy running-config startup-config',
  'cop run start': 'copy running-config startup-config',
  'copy run start': 'copy running-config startup-config',
  'cop run startu': 'copy running-config startup-config',
  'copy run startu': 'copy running-config startup-config',
  'cop run startup': 'copy running-config startup-config',
  'copy run startup': 'copy running-config startup-config',
  'cop run startup-c': 'copy running-config startup-config',
  'copy run startup-c': 'copy running-config startup-config',
  'cop run startup-co': 'copy running-config startup-config',
  'copy run startup-co': 'copy running-config startup-config',
  'cop run startup-con': 'copy running-config startup-config',
  'copy run startup-con': 'copy running-config startup-config',
  'cop run startup-conf': 'copy running-config startup-config',
  'copy run startup-conf': 'copy running-config startup-config',
  'cop run startup-confi': 'copy running-config startup-config',
  'copy run startup-confi': 'copy running-config startup-config',
  'cop r st': 'copy running-config startup-config',
  'copy r st': 'copy running-config startup-config',
  ...
  'do wr': 'do write memory',
  'do wri': 'do write memory',
